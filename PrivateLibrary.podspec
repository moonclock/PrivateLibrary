...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/moonclock/PrivateLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'moonclock' => '514342179@qq.com' }
  s.source           = { :git => 'https://github.com/moonclock/PrivateLibrary.git', :tag => s.version.to_s }
